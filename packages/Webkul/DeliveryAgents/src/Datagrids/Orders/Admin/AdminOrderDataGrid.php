...
namespace Webkul\DeliveryAgents\Datagrids\Orders\Admin;
...
class AdminOrderDataGrid extends DataGrid
{
    /**
    ...
    public function prepareColumns()
    {
        ...
        $this->addColumn([
            ...
            'filterable_options' => [
                ...
                [
                    'label' => trans('admin::app.sales.orders.index.datagrid.assigned_to_agent'),
                    'value' => Order::STATUS_ASSIGNED_TO_AGENT,
                ],
                [
                    'label' => trans('admin::app.sales.orders.index.datagrid.accepted_by_agent'),
                    'value' => Order::STATUS_ACCEPTED_BY_AGENT,
                ],
                [
                    'label' => trans('admin::app.sales.orders.index.datagrid.rejected_by_agent'),
                    'value' => Order::STATUS_REJECTED_BY_AGENT,
                ],
                [
                    'label' => trans('admin::app.sales.orders.index.datagrid.out_for_delivery'),
            ...
            'closure'    => function ($row) {
                switch ($row->status) {
                    ...
                    case Order::STATUS_ASSIGNED_TO_AGENT:
                        return '<p class="label-assigned_to_agent">'.trans('admin::app.sales.orders.index.datagrid.assigned_to_agent').'</p>';

                    case Order::STATUS_ACCEPTED_BY_AGENT:
                        return '<p class="label-accepted_by_agent">'.trans('admin::app.sales.orders.index.datagrid.accepted_by_agent').'</p>';

                    case Order::STATUS_REJECTED_BY_AGENT:
                        return '<p class="label-rejected_by_agent">'.trans('admin::app.sales.orders.index.datagrid.rejected_by_agent').'</p>';

                    case Order::STATUS_OUT_FOR_DELIVERY:
                        return '<p class="label-out_for_delivery">'.trans('admin::app.sales.orders.index.datagrid.out_for_delivery').'</p>';
                }
            },
        ]);

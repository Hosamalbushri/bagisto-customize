...
@pushOnce('scripts')
    ...
    >
        <div>
            ...
            >
                <div
                    class="fixed inset-0 modal-confirm-z-index bg-gray-500 bg-opacity-50 transition-opacity"
                    v-show="isOpen"
                ></div>
            </transition>
            ...
            >
                <div
                    class="fixed inset-0 modal-confirm-z-index transform overflow-y-auto transition"
                    v-if="isOpen"
                >

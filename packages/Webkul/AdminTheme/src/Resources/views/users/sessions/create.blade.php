                ...
                <x-admin::form :action="route('admin.session.custom.create')">
                    ...
                    <div class="border-y p-4 dark:border-gray-800">
                        ...
                        <x-admin::form.control-group class="mb-4">
                            <x-admin::form.control-group.label class="login-label required">
                            ...
                            <x-admin::form.control-group.error class="login-error" control-name="email" />
                        </x-admin::form.control-group>

                        <!-- Password -->
                        <x-admin::form.control-group class="mb-4 relative">
                            <x-admin::form.control-group.label class="login-label required">
                            ...
                            <x-admin::form.control-group.control
                                type="password"
                                class="login-input ltr:pr-10 rtl:pl-10"
                                id="password"
                                name="password"
                            ...
                            <x-admin::form.control-group.error class="login-error" control-name="password" />
                        </x-admin::form.control-group>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-4">
                        ...
                        <!-- Submit Button -->
                        <button
                            class="login-buttons-colors px-3.5 py-1.5 rounded-md"

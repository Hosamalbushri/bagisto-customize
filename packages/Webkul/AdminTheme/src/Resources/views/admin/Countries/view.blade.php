<x-admin::layouts>
    ...
    @pushOnce('scripts')
        ...
        >
            <x-slot:title>
                @php
                    $label = trans('adminTheme::app.country.view.title');
                @endphp
                ...
                <div class="grid">
                    <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
                        <div class="flex items-center gap-2.5">
                            ...
                            <template v-else>
                                <h1
                                    ...
                                    @lang('adminTheme::app.country.view.title')
                                    v-text="`@lang('adminTheme::app.country.view.title'):  ${country.name}`"></h1>
                            </template>
                        </div>
                        ...
                        >
                            @lang('adminTheme::app.country.view.back-btn')
                        </a>
                    </div>
                </div>
                ...
                <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
                    ...
                    <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                        @if (bouncer()->hasPermission('delivery.countries.states'))
                            @include('adminTheme::admin.Countries.view.States.index')
                                ...
                                <x-slot:header>
                                    <div class="flex w-full">
                                        <p class="w-full p-2.5 text-base font-semibold text-gray-800 dark:text-white">
                                            @lang('adminTheme::app.country.view.country')
                                        </p>

                                        <!--Countries Edit Component -->
                                        @include('adminTheme::admin.Countries.view.edit')
                                    </div>
                                </x-slot:header>
                                        ...
                                        <div class="grid gap-y-2.5">
                                            <x-admin::form.control-group>
                                                <x-admin::form.control-group.label>
                                                    @lang('adminTheme::app.country.view.name')
                                                </x-admin::form.control-group.label>
                                            ...
                                            <x-admin::form.control-group>
                                                <x-admin::form.control-group.label>
                                                    @lang('adminTheme::app.country.view.code')
                                                </x-admin::form.control-group.label>

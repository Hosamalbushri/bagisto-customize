<x-admin::layouts>
    ...
    @pushOnce('scripts')
        ...
        >
            <x-slot:title>
                @php
                    $label = trans('adminTheme::app.country.state.view.title');
                @endphp
                ...
                <div class="grid">
                    <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
                        <div class="flex items-center gap-2.5">
                            ...
                            <template v-else>
                                <h1
                                    ...
                                    v-text="`@lang('adminTheme::app.country.state.view.title'):  ${state.default_name}`"                                ></h1>
                            </template>
                        </div>
                        ...
                        >
                            @lang('adminTheme::app.country.state.view.back-btn')
                        </a>
                    </div>
                </div>
                ...
                <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
                    ...
                    <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                        @if (bouncer()->hasPermission('delivery.countries.states.area'))
                            @include('adminTheme::admin.Countries.view.States.Areas.index')
                        @endif
                                        ...
                                        <div class="grid gap-y-2.5">
                                            <x-admin::form.control-group>
                                                <x-admin::form.control-group.label>
                                                    @lang('adminTheme::app.country.state.view.name')
                                                </x-admin::form.control-group.label>
                                            ...
                                            <x-admin::form.control-group>
                                                <x-admin::form.control-group.label>
                                                    @lang('adminTheme::app.country.state.view.code')
                                                </x-admin::form.control-group.label>

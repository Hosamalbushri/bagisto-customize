...
@if (bouncer()->hasPermission('delivery.countries.states.edit'))
    ...
    >
        @lang('adminTheme::app.country.state.edit.edit-btn')
    </div>
@endif
            ...
            >
                ...
                >
                    <x-admin::modal ref="modal" ref="StateEditModal">
                        <x-slot:header>
                            @lang('adminTheme::app.country.edit.title')
                            </x-slot>
                            ...
                            <x-slot:content>
                                ...
                                <x-admin::form.control-group  class="mb-2.5 w-full">
                                    <x-admin::form.control-group.label class="required">
                                        @lang('adminTheme::app.country.state.edit.name')
                                    ...
                                    <x-admin::form.control-group.control
                                        ...
                                        rules="required"
                                        :label="trans('adminTheme::app.country.state.edit.name')"
                                        :placeholder="trans('adminTheme::app.country.state.edit.name')"
                                    />
                                ...
                                <x-admin::form.control-group class="mb-2.5 w-full">
                                    <x-admin::form.control-group.label >
                                        @lang('adminTheme::app.country.state.edit.code')
                                    </x-admin::form.control-group.label>
                                    ...
                                    <x-admin::form.control-group.control
                                        ...
                                        ::value="state.code"
                                        disabled
                                        :label="trans('adminTheme::app.country.state.edit.code')"
                                        :placeholder="trans('adminTheme::app.country.state.edit.code')"
                                    />
                                ...
                                <x-slot:footer>
                                    <x-admin::button
                                        ...
                                        :title="trans('adminTheme::app.country.state.edit.edit-btn')"
                                        ::loading="isLoading"
                                        ::disabled="isLoading"
                                    />
                                    </x-slot>

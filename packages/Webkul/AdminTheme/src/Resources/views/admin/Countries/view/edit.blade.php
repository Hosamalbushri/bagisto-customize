...
@if (bouncer()->hasPermission('delivery.countries.country.edit'))
    ...
    >
        @lang('adminTheme::app.country.edit.edit-btn')
    </div>
@endif
                            ...
                            <x-slot:content>
                                ...
                                <x-admin::form.control-group  class="mb-2.5 w-full">
                                    <x-admin::form.control-group.label class="required">
                                        @lang('adminTheme::app.country.edit.name')
                                    ...
                                    <x-admin::form.control-group.control
                                        ...
                                        ::value="country.name"
                                        rules="required"
                                        :label="trans('adminTheme::app.country.edit.name')"
                                        :placeholder="trans('adminTheme::app.country.edit.name')"
                                    />
                                ...
                                <x-admin::form.control-group class="mb-2.5 w-full">
                                    <x-admin::form.control-group.label >
                                        @lang('adminTheme::app.country.edit.code')
                                    </x-admin::form.control-group.label>
                                    ...
                                    <x-admin::form.control-group.control
                                        ...
                                        ::value="country.code"
                                        disabled
                                        :label="trans('adminTheme::app.country.edit.code')"
                                        :placeholder="trans('adminTheme::app.country.edit.code')"
                                    />
                                ...
                                <x-slot:footer>
                                    <x-admin::button
                                        ...
                                        :title="trans('adminTheme::app.country.edit.edit-btn')"
                                        ::loading="isLoading"
                                        ::disabled="isLoading"
                                    />
                                    </x-slot>

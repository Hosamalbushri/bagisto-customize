            ...
            >
                <form @submit="handleSubmit($event, create)" >
                    <x-admin::modal ref="modal" ref="CountryCreateModal">
                        ...
                        <x-slot:header>
                            @lang('adminTheme::app.country.create.title')
                            </x-slot>
                            ...
                            <x-slot:content>
                                    ...
                                    <x-admin::form.control-group  class="mb-2.5 w-full">
                                        <x-admin::form.control-group.label class="required">
                                            @lang('adminTheme::app.country.create.name')
                                        ...
                                        <x-admin::form.control-group.control
                                            ...
                                            id="name"
                                            rules="required"
                                            :label="trans('adminTheme::app.country.create.name')"
                                            :placeholder="trans('adminTheme::app.country.create.name')"
                                        />
                                    ...
                                    <x-admin::form.control-group class="mb-2.5 w-full">
                                        <x-admin::form.control-group.label class="required">
                                            @lang('adminTheme::app.country.create.code')
                                        </x-admin::form.control-group.label>
                                        ...
                                        <x-admin::form.control-group.control
                                            ...
                                            name="code"
                                            rules="required"
                                            :label="trans('adminTheme::app.country.create.code')"
                                            :placeholder="trans('adminTheme::app.country.create.code')"
                                        />
                                ...
                                <x-slot:footer>
                                    <x-admin::button
                                        ...
                                        :title="trans('adminTheme::app.country.create.create-btn')"
                                        ::loading="isLoading"
                                        ::disabled="isLoading"
                                    />
                                </x-slot:footer>

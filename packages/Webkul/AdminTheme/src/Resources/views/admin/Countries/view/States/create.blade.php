...
@pushOnce('scripts')
    ...
    >
        ...
        >
            ...
            @lang('adminTheme::app.country.view.states.create-btn')
        </button>
        <div id="state-form">
            <x-admin::form
            ...
            >
                <form @submit="handleSubmit($event, create)" >
                    <x-admin::modal ref="modal" ref="StateCreateModal">
                        <x-slot:header>
                            @lang('adminTheme::app.country.state.create.title')
                        </x-slot:header>
                            <x-slot:content>
                                <x-admin::form.control-group  class="mb-2.5 w-full">
                                    <x-admin::form.control-group.label class="required">
                                        @lang('adminTheme::app.country.state.create.name')
                                    ...
                                    <x-admin::form.control-group.control
                                        ...
                                        id="default_name"
                                        rules="required"
                                        :label="trans('adminTheme::app.country.state.create.name')"
                                        :placeholder="trans('adminTheme::app.country.state.create.name')"
                                    />
                                ...
                                <x-admin::form.control-group class="mb-2.5 w-full">
                                    <x-admin::form.control-group.label class="required">
                                        @lang('adminTheme::app.country.state.create.code')
                                    </x-admin::form.control-group.label>
                                    ...
                                    <x-admin::form.control-group.control
                                        ...
                                        name="code"
                                        rules="required"
                                        :label="trans('adminTheme::app.country.state.create.code')"
                                        :placeholder="trans('adminTheme::app.country.state.create.code')"
                                    />
                                ...
                                <x-slot:footer>
                                    <x-admin::button
                                        ...
                                        :title="trans('adminTheme::app.country.state.create.create-btn')"
                                        ::loading="isLoading"
                                        ::disabled="isLoading"
                                    />
                                </x-slot:footer>

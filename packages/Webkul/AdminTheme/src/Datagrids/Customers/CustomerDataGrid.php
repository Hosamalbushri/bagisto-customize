...
namespace Webkul\AdminTheme\Datagrids\Customers;
...
class CustomerDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        ...
        $this->addColumn([
            ...
            'closure'    => function ($row) {
                switch ($row->status) {
                    ...
                    case '0':
                        return '<p class="label-canceled">'.trans('admin::app.customers.customers.index.datagrid.inactive').'</p>';
                }
            },
        ]);
        ...
        $this->addColumn([
            ...
            'sortable'   => true,
            'closure'    => function ($row) {
                switch ($row->is_suspended) {
                    case '1':
                        return '<p class="label-pending">'.trans('admin::app.customers.customers.index.datagrid.suspended').'</p>';
                    case '0':
                        return '<p>'.'</p>';
                }
            },

...
namespace Webkul\AdminTheme\Datagrids\Customers\View;
            ...
            'closure'    => function ($row) {
                switch ($row->status) {
                    ...
                    case Order::STATUS_ASSIGNED_TO_AGENT:
                        return '<p class="label-assigned_to_agent">'.trans('adminTheme::app.customers.customers.view.datagrid.orders.assigned_to_agent').'</p>';

                    case Order::STATUS_ACCEPTED_BY_AGENT:
                        return '<p class="label-closed">'.trans('adminTheme::app.customers.customers.view.datagrid.orders.accepted_by_agent').'</p>';

                    case Order::STATUS_REJECTED_BY_AGENT:
                        return '<p class="label-rejected_by_agent">'.trans('adminTheme::app.customers.customers.view.datagrid.orders.rejected_by_agent').'</p>';

                    case Order::STATUS_OUT_FOR_DELIVERY:
                        return '<p class="label-out_for_delivery">'.trans('adminTheme::app.customers.customers.view.datagrid.orders.out_for_delivery').'</p>';
                }
            },
        ]);

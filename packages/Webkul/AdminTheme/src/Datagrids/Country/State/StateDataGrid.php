...
namespace Webkul\AdminTheme\Datagrids\Country\State;
...
class StateDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        $this->addColumn([
            ...
            'label'      => trans('adminTheme::app.country.state.dataGrid.id'),
            'type'       => 'integer',
            'searchable' => false,
            'sortable'   => true,
            'filterable' => true,
        ...
        $this->addColumn([
            'index'      => 'default_name',
            'label'      => trans('adminTheme::app.country.state.dataGrid.name'),
            'type'       => 'string',
            'searchable' => true,
            'sortable'   => true,
            'filterable' => true,
        ...
        $this->addColumn([
            'index'      => 'code',
            'label'      => trans('adminTheme::app.country.state.dataGrid.code'),
            'type'       => 'string',
            'searchable' => true,
            'sortable'   => true,
            'filterable' => true,
    ...
    public function prepareActions()
    {
        ...
        $this->addAction([
            'icon'   => 'icon-sort-left',
            'title'  => trans('adminTheme::app.country.state.dataGrid.actions.view'),
            'method' => 'GET',
            'url'    => function ($row) {
        ...
        if (bouncer()->hasPermission('delivery.countries.states.delete')) {
            ...
            $this->addAction([
                'icon'   => 'icon-delete',
                'title'  => trans('adminTheme::app.country.state.dataGrid.actions.delete'),
                'method' => 'DELETE',
                'url'    => function ($row) {

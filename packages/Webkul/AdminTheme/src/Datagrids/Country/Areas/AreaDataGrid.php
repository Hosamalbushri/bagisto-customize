...
namespace Webkul\AdminTheme\Datagrids\Country\Areas;
...
class AreaDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        $this->addColumn([
            ...
            'label'      => trans('adminTheme::app.country.state.area.dataGrid.id'),
            'type'       => 'integer',
            'searchable' => true,
            'sortable'   => true,
            'filterable' => true,
        ...
        $this->addColumn([
            'index'      => 'area_name',
            'label'      => trans('adminTheme::app.country.state.area.dataGrid.name'),
            'type'       => 'string',
            'searchable' => true,
            'sortable'   => true,
            'filterable' => true,
        ...
        $this->addColumn([
            ...
            'label'      => trans('adminTheme::app.country.state.area.dataGrid.delivery-count'),
            'type'       => 'string',
            'searchable' => true,
            'sortable'   => true,
            'filterable' => true,
    ...
    public function prepareActions()
    {
        $this->addAction([
            'index'  => 'view',
            'icon'   => 'icon-view',
            'title'  => trans('adminTheme::app.country.state.area.dataGrid.actions.edit'),
            'method' => 'GET',
            'url'    => function ($row) {
        ...
        if (bouncer()->hasPermission('delivery.countries.states.area.delete')) {
            ...
            $this->addAction([
                'index'  => 'delete',
                'icon'   => 'icon-delete',
                'title'  => trans('adminTheme::app.country.state.area.dataGrid.actions.delete'),
                'method' => 'DELETE',
                'url'    => function ($row) {

...
namespace Webkul\AdminTheme\Datagrids\Country;
...
class CountryDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        ...
        $this->addColumn([
            'index'      => 'countries_id',
            'label'      => trans('adminTheme::app.country.dataGrid.id'),
            'type'       => 'integer',
            'searchable' => false,
            'sortable'   => true,
            'filterable' => true,
        ...
        $this->addColumn([
            'index'      => 'name',
            'label'      => trans('adminTheme::app.country.dataGrid.name'),
            'type'       => 'string',
            'searchable' => true,
            'sortable'   => true,
            'filterable' => true,
        ...
        $this->addColumn([
            'index'      => 'code',
            'label'      => trans('adminTheme::app.country.dataGrid.code'),
            'type'       => 'string',
            'searchable' => true,
            'filterable' => true,
        ...
        $this->addColumn([
            'index'      => 'states_count',
            'label'      => trans('adminTheme::app.country.dataGrid.states_count'),
            'type'       => 'integer',
            'searchable' => false,
            'sortable'   => true,
        ]);
    ...
    public function prepareActions()
    {
        if (bouncer()->hasPermission('delivery.countries.country.edit')) {
            $this->addAction([
                'icon'   => 'icon-sort-left',
                'title'  => trans('adminTheme::app.country.dataGrid.actions.view'),
                'method' => 'GET',
                'url'    => function ($row) {
        ...
        if (bouncer()->hasPermission('delivery.countries.country.delete')) {
            ...
            $this->addAction([
                'icon'   => 'icon-delete',
                'title'  => trans('adminTheme::app.country.dataGrid.actions.delete'),
                'method' => 'DELETE',
                'url'    => function ($row) {

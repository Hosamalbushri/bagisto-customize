...
namespace Webkul\AdminTheme\Datagrids\Catalog;
    ...
    public function prepareColumns()
    {
        ...
        $this->addColumn([
            ...
            'filterable_options' => DB::table('category_translations')
                ...
                ->pluck('name as label', 'category_id as value')
        ...
        $this->addColumn([
            ...
            'closure'    => function ($row) {
                switch ($row->status) {
                    case '1':
                        return '<p class="label-active">'.trans('admin::app.catalog.products.index.datagrid.active').'</p>';
                    case '0':
                        return '<p class="label-info">'.trans('admin::app.catalog.products.index.datagrid.disable').'</p>';
                }
            },
        ]);

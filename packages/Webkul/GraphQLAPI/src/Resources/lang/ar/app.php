    ...
    'shop' => [
        'validation' => [
            ...
            'address' => [
                ...
                'array'    => 'العنوان يجب أن يكون مصفوفة.',
                'min'      => 'يجب إدخال عنوان واحد على الأقل.',
            ],
            'country' => [
                'required' => 'البلد مطلوب.',
                'string'   => 'البلد يجب أن يكون نصاً.',
            ],
            'state' => [
                'required' => 'الولاية مطلوبة.',
                'string'   => 'الولاية يجب أن تكون نصاً.',
            ],
            'state_area_id' => [
                'required' => 'المنطقة مطلوبة.',
                'string'   => 'معرف المنطقة يجب أن يكون نصاً.',
            ...
            'company_name' => [
                'string' => 'اسم الشركة يجب أن يكون نصاً.',
            ],
            'vat_id' => [
                'string' => 'رقم الضريبة يجب أن يكون نصاً.',
            ],
        ],
        'subscription' => [
